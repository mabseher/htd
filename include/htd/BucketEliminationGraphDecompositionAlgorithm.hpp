...
namespace htd
{
    ...
    class HTD_API BucketEliminationGraphDecompositionAlgorithm : public htd::IGraphDecompositionAlgorithm
    {
        public:
             ...
             */
            BucketEliminationGraphDecompositionAlgorithm(const htd::LibraryInstance * const manager);
             ...
             */
            BucketEliminationGraphDecompositionAlgorithm(const htd::LibraryInstance * const manager, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations);

            virtual ~BucketEliminationGraphDecompositionAlgorithm();
