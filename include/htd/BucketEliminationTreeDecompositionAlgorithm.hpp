...
namespace htd
{
    ...
    class HTD_API BucketEliminationTreeDecompositionAlgorithm : public htd::ITreeDecompositionAlgorithm
    {
        public:
             ...
             */
            BucketEliminationTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager);
             ...
             */
            BucketEliminationTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations);

            virtual ~BucketEliminationTreeDecompositionAlgorithm();
