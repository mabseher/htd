...
namespace htd
{
    ...
    class HeuristicSetCoverAlgorithm : public virtual htd::ISetCoverAlgorithm
    {
        ...
        private:
            ...
            void populateNeighborhood(const htd::ConstCollection<std::vector<htd::id_t>> & containers, std::vector<HistoryEntry> & newNeighborhood, std::size_t bestSolutionFitness, const std::vector<HistoryEntry> & origin) const;

            void populateNeighborhood(const htd::ConstCollection<std::vector<htd::id_t>> & containers, std::vector<HistoryEntry> & newNeighborhood, std::size_t bestSolutionFitness, const HistoryEntry & individual) const;
    };
}
