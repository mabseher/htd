...
namespace htd
{
    class HypertreeDecomposition : public TreeDecomposition, public virtual htd::IMutableHypertreeDecomposition
    {
        public:
            ...
            const htd::Collection<htd::Hyperedge> edgeLabel(htd::vertex_t vertex) const HTD_OVERRIDE;

            void setEdgeLabel(htd::vertex_t vertex, const htd::hyperedge_container & content) HTD_OVERRIDE;

            void setEdgeLabel(htd::vertex_t vertex, const htd::Collection<htd::Hyperedge> & content) HTD_OVERRIDE;
