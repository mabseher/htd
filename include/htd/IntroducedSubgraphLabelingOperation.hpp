...
namespace htd
{
    ...
    class IntroducedSubgraphLabelingOperation : public virtual htd::IPathDecompositionManipulationOperation, public virtual htd::ITreeDecompositionManipulationOperation
    {
        public:
             ...
             */
            HTD_API static constexpr const char * INTRODUCED_SUBGRAPH_LABEL_IDENTIFIER = "Introduced Subgraph";

            /**
             *  Constructor for a new manipulation operation of type IntroducedSubgraphLabelingOperation.
             *
             *  @param[in] manager   The management instance to which the new manipulation operation belongs.
             */
            HTD_API IntroducedSubgraphLabelingOperation(const htd::LibraryInstance * const manager);

            HTD_API virtual ~IntroducedSubgraphLabelingOperation();
            ...
            HTD_API IntroducedSubgraphLabelingOperation * clone(void) const HTD_OVERRIDE;
#else
            /**
             ...
             */
            HTD_API IntroducedSubgraphLabelingOperation * clone(void) const;
