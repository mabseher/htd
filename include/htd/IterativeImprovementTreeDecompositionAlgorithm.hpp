...
namespace htd
{
    ...
    class HTD_API IterativeImprovementTreeDecompositionAlgorithm : public htd::ITreeDecompositionAlgorithm
    {
        public:
             ...
             */
            IterativeImprovementTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager, const htd::ITreeDecompositionAlgorithm & algorithm, const htd::ITreeDecompositionFitnessFunction & fitnessFunction);
             ...
             *  @param[in] fitnessFunction  The fitness function which will be used to evaluate the constructed tree decompositions.
             */
            IterativeImprovementTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager, htd::ITreeDecompositionAlgorithm * algorithm, const htd::ITreeDecompositionFitnessFunction & fitnessFunction);
             ...
             */
            IterativeImprovementTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager, const htd::ITreeDecompositionAlgorithm & algorithm, const htd::ITreeDecompositionFitnessFunction & fitnessFunction, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations);
             ...
             *  @param[in] manipulationOperations   The manipulation operations which shall be applied globally to each decomposition generated by the algorithm.
             */
            IterativeImprovementTreeDecompositionAlgorithm(const htd::LibraryInstance * const manager, htd::ITreeDecompositionAlgorithm * algorithm, const htd::ITreeDecompositionFitnessFunction & fitnessFunction, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations);

            virtual ~IterativeImprovementTreeDecompositionAlgorithm();
             ...
             */
            std::size_t iterationCount(void) const;
             ...
             */
            std::size_t nonImprovementLimit(void) const;
             ...
             */
            void setNonImprovementLimit(std::size_t nonImprovementLimit);
            ...
            IterativeImprovementTreeDecompositionAlgorithm * clone(void) const HTD_OVERRIDE;
