...
namespace htd
{
     ...
     */
    class HTD_API LabeledGraph : public htd::Graph, public virtual htd::IMutableLabeledGraph
    {
        public:
            /**
            ...
            htd::IMutableLabeledGraph * cloneMutableLabeledGraph(void) const HTD_OVERRIDE;
#endif
