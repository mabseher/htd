...
namespace htd
{
     ...
     */
    class HTD_API LabeledMultiHypergraph : public htd::MultiHypergraph, public virtual htd::IMutableLabeledMultiHypergraph
    {
        public:
            /**
             ...
             */
            LabeledMultiHypergraph(const htd::LibraryInstance * const manager);
             ...
             */
            LabeledMultiHypergraph(const htd::LibraryInstance * const manager, std::size_t initialSize);
             ...
             */
            LabeledMultiHypergraph * clone(void) const;
