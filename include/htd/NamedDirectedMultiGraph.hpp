/*
 * File:   NamedDirectedMultiGraph.hpp
 *
...
#ifndef HTD_HTD_NAMEDDIRECTEDMULTIGRAPH_HPP
#define	HTD_HTD_NAMEDDIRECTEDMULTIGRAPH_HPP
...
{
    /**
     *  Implementation of a directed graph with potentially duplicated edges in which vertices and edges can be accessed by their names.
     */
    template<typename VertexNameType, typename EdgeNameType>
    class NamedDirectedMultiGraph
    {
        public:
            /**
             *  Constructor for a directed multi-graph.
             */
            NamedDirectedMultiGraph(void) : base_(htd::LabeledDirectedMultiGraphFactory::instance().getLabeledDirectedMultiGraph()), names_(), vertexCreationFunction_(std::bind(&htd::IMutableLabeledDirectedMultiGraph::addVertex, base_))
            {
             ...
             */
            NamedDirectedMultiGraph(const NamedDirectedMultiGraph<VertexNameType, EdgeNameType> & original) : base_(original.base_->clone()), names_(original.names_), vertexCreationFunction_(std::bind(&htd::IMutableLabeledDirectedMultiGraph::addVertex, base_))
            {

            }

            /**
             *  Destructor for a NamedDirectedMultiGraph object.
             */
            ~NamedDirectedMultiGraph()
            {
                if (base_ != nullptr)
                {
                    delete base_;
            ...
            void setVertexName(htd::vertex_t vertex, const VertexNameType & name)
            {
                ...
                {
                    throw std::logic_error("void htd::NamedDirectedMultiGraph<VertexNameType, EdgeNameType>::setVertexName(htd::vertex_t, const VertexNameType &)");
                }
            ...
            void setEdgeName(htd::id_t edgeId, const EdgeNameType & name)
            {
                ...
                {
                    throw std::logic_error("void htd::NamedDirectedMultiGraph<VertexNameType, EdgeNameType>::setEdgeName(htd::id_t, const EdgeNameType &)");
                }
            ...
            const VertexNameType & vertexName(htd::vertex_t vertex) const
            {
                ...
                {
                    throw std::logic_error("const VertexNameType & htd::NamedDirectedMultiGraph<VertexNameType, EdgeNameType>::vertexName(htd::vertex_t) const");
                }
            ...
            const EdgeNameType & edgeName(htd::id_t edgeId) const
            {
                ...
                {
                    throw std::logic_error("const EdgeNameType & htd::NamedDirectedMultiGraph<VertexNameType, EdgeNameType>::edgeName(htd::id_t) const");
                }
            ...
            htd::vertex_t lookupVertex(const VertexNameType & vertexName) const
            {
                ...
                {
                    throw std::logic_error("htd::vertex_t htd::NamedDirectedMultiGraph<VertexNameType, EdgeNameType>::lookupVertex(const VertexNameType &) const");
                }
            ...
            htd::NamedVertexHyperedge<VertexNameType> lookupHyperedge(const EdgeNameType & edgeName) const
            {
                ...
                {
                    throw std::logic_error("htd::NamedVertexHyperedge<VertexNameType> htd::NamedDirectedMultiGraph<VertexNameType, EdgeNameType>::lookupHyperedge(const EdgeNameType &) const");
                }
            ...
            htd::id_t associatedEdgeId(const EdgeNameType & edgeName) const
            {
                if (!names_.isEdgeName(edgeName))
                {
                    throw std::logic_error("htd::id_t htd::NamedDirectedMultiGraph<VertexNameType, EdgeNameType>::associatedEdgeId(const EdgeNameType &) const");
                }
            ...
            /**
             *  Add a new vertex to the directed multi-graph if it does not already exist.
             *
            ...
            /**
             *  Add new vertices to the directed multi-graph if they do not already exist.
             *
             *  @param[in] vertexNames  The names of the vertices which shall be added.
             *
             *  @return A vector containing for each provided vertex name the ID of the vertex in the directed multi-graph. Existing vertices keep their ID.
             */
             ...
             *  @param[in] vertexName1  The first endpoint of the edge.
             *  @param[in] vertexName2  The second endpoint of the edge.
             *  @param[in] name         The name assigned to the new edge.
             *
             *  @return The ID of the new edge.
             */
             ...
             */
            NamedDirectedMultiGraph<VertexNameType, EdgeNameType> * clone(void) const
            {
                return new NamedDirectedMultiGraph<VertexNameType, EdgeNameType>(*this);
            }

            /**
             *  Access the underlying ILabeledDirectedMultiGraph object.
             *
             *  @return The underlying ILabeledDirectedMultiGraph object.
             */
            const htd::ILabeledDirectedMultiGraph & internalGraph(void) const
            {
                return *base_;
            }

        private:
            htd::IMutableLabeledDirectedMultiGraph * base_;
...
#endif /* HTD_HTD_NAMEDDIRECTEDMULTIGRAPH_HPP */
