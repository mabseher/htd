...
{
    /**
     *  Implementation of a graph with potentially duplicated edges in which vertices and edges can be accessed by their names.
     */
    ...
    class NamedMultiGraph
    {
        public:
             ...
             */
            NamedMultiGraph(const htd::LibraryInstance * const manager) : base_(manager->labeledMultiGraphFactory().createInstance()), names_(), vertexCreationFunction_(std::bind(&htd::IMutableLabeledMultiGraph::addVertex, base_))
            {
             ...
             */
            NamedMultiGraph(const NamedMultiGraph<VertexNameType, EdgeNameType> & original) : base_(original.base_->clone()), names_(original.names_), vertexCreationFunction_(std::bind(&htd::IMutableLabeledMultiGraph::addVertex, base_))
            {
            ...
            /**
             *  Add a new vertex to the multi-graph if it does not already exist.
             *
            ...
            /**
             *  Add new vertices to the multi-graph if they do not already exist.
             *
             *  @param[in] vertexNames  The names of the vertices which shall be added.
             *
             *  @return A vector containing for each provided vertex name the ID of the vertex in the multi-graph. Existing vertices keep their ID.
             */
            ...
            /**
             *  Access the underlying ILabeledMultiGraph object.
             *
             *  @return The underlying ILabeledMultiGraph object.
             */
