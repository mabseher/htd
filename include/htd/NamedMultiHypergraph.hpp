...
#ifndef HTD_HTD_NAMEDMULTIHYPERGRAPH_HPP
#define	HTD_HTD_NAMEDMULTIHYPERGRAPH_HPP
...
{
    /**
     *  Implementation of a hypergraph with potentially duplicated edges in which vertices and edges can be accessed by their names.
     */
    ...
    class NamedMultiHypergraph
    {
        public:
            ...
            /**
             *  Destructor for a NamedMultiHypergraph object.
             */
            ~NamedMultiHypergraph()
            {
                if (base_ != nullptr)
                {
                    delete base_;
            ...
            void setVertexName(htd::vertex_t vertex, const VertexNameType & name)
            {
                ...
                {
                    throw std::logic_error("void htd::NamedMultiHypergraph<VertexNameType, EdgeNameType>::setVertexName(htd::vertex_t, const VertexNameType &)");
                }
            ...
            void setEdgeName(htd::id_t edgeId, const EdgeNameType & name)
            {
                ...
                {
                    throw std::logic_error("void htd::NamedMultiHypergraph<VertexNameType, EdgeNameType>::setEdgeName(htd::id_t, const EdgeNameType &)");
                }
            ...
            const VertexNameType & vertexName(htd::vertex_t vertex) const
            {
                ...
                {
                    throw std::logic_error("const VertexNameType & htd::NamedMultiHypergraph<VertexNameType, EdgeNameType>::vertexName(htd::vertex_t) const");
                }
            ...
            const EdgeNameType & edgeName(htd::id_t edgeId) const
            {
                ...
                {
                    throw std::logic_error("const EdgeNameType & htd::NamedMultiHypergraph<VertexNameType, EdgeNameType>::edgeName(htd::id_t) const");
                }
            ...
            htd::vertex_t lookupVertex(const VertexNameType & vertexName) const
            {
                ...
                {
                    throw std::logic_error("htd::vertex_t htd::NamedMultiHypergraph<VertexNameType, EdgeNameType>::lookupVertex(const VertexNameType &) const");
                }
            ...
            htd::NamedVertexHyperedge<VertexNameType> lookupHyperedge(const EdgeNameType & edgeName) const
            {
                ...
                {
                    throw std::logic_error("htd::NamedVertexHyperedge<VertexNameType> htd::NamedMultiHypergraph<VertexNameType, EdgeNameType>::lookupHyperedge(const EdgeNameType &) const");
                }
            ...
            htd::id_t associatedEdgeId(const EdgeNameType & edgeName) const
            {
                if (!names_.isEdgeName(edgeName))
                {
                    throw std::logic_error("htd::id_t htd::NamedMultiHypergraph<VertexNameType, EdgeNameType>::associatedEdgeId(const EdgeNameType &) const");
                }
            ...
            /**
             *  Add a new vertex to the multi-hypergraph if it does not already exist.
             *
            ...
            /**
             *  Add new vertices to the multi-hypergraph if they do not already exist.
             *
             *  @param[in] vertexNames  The names of the vertices which shall be added.
             *
             *  @return A vector containing for each provided vertex name the ID of the vertex in the multi-hypergraph. Existing vertices keep their ID.
             */
             ...
             */
            NamedMultiHypergraph<VertexNameType, EdgeNameType> * clone(void) const
            {
                return new NamedMultiHypergraph<VertexNameType, EdgeNameType>(*this);
            }

            /**
             *  Access the underlying ILabeledMultiHypergraph object.
             *
             *  @return The underlying ILabeledMultiHypergraph object.
             */
            const htd::ILabeledMultiHypergraph & internalGraph(void) const
            {
                return *base_;
            }
...
#endif /* HTD_HTD_NAMEDMULTIHYPERGRAPH_HPP */
