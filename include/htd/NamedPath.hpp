...
{
    /**
     *  Implementation of a path in which vertices and edges can be accessed by their names.
     */
    ...
    class NamedPath
    {
        public:
            ...
            htd::id_t associatedEdgeId(const EdgeNameType & edgeName) const
            {
                ...
                {
                    throw std::logic_error("htd::id_t htd::NamedPath<VertexNameType, EdgeNameType>::associatedEdgeId(const EdgeNameType &) const");
                }
            ...
            void removeChild(const VertexNameType & vertexName)
            {
                ...
                names_.removeVertexName(base_->child(vertex));
            ...
            /**
             *  Access the collection of all label names used in the path.
             *
             *  @return The collection of all label names used in the path sorted in ascending order.
             */
