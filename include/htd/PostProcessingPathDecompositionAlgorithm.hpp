...
namespace htd
{
    ...
    class HTD_API PostProcessingPathDecompositionAlgorithm : public virtual htd::IPathDecompositionAlgorithm
    {
        public:
             ...
             */
            PostProcessingPathDecompositionAlgorithm(const htd::LibraryInstance * const manager);
             ...
             */
            PostProcessingPathDecompositionAlgorithm(const htd::LibraryInstance * const manager, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations);

            virtual ~PostProcessingPathDecompositionAlgorithm();
