...
namespace htd
{
    ...
    class TreeDecomposition : public htd::LabeledTree, public virtual htd::IMutableTreeDecomposition
    {
        public:
            ...
            HTD_API std::size_t joinVertexCount(htd::vertex_t vertex) const HTD_OVERRIDE;

            HTD_API htd::ConstCollection<htd::vertex_t> joinVertices(htd::vertex_t vertex) const HTD_OVERRIDE;

            HTD_API void copyJoinVerticesTo(std::vector<htd::vertex_t> & target, htd::vertex_t vertex) const HTD_OVERRIDE;

            HTD_API htd::vertex_t joinVertexAtPosition(htd::vertex_t vertex, htd::index_t index) const HTD_OVERRIDE;

            HTD_API bool isJoinVertex(htd::vertex_t vertex, htd::vertex_t joinVertex) const HTD_OVERRIDE;
