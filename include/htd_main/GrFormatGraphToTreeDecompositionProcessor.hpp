...
#ifndef HTD_MAIN_GRFORMATGRAPHTOTREEDECOMPOSITIONPROCESSOR_HPP
#define HTD_MAIN_GRFORMATGRAPHTOTREEDECOMPOSITIONPROCESSOR_HPP
...
namespace htd_main
{
     ...
     */
    class GrFormatGraphToTreeDecompositionProcessor : public htd_main::IGraphToTreeDecompositionProcessor
    {
        public:
            /**
             *  Constructor for a new graph processor.
             */
            GrFormatGraphToTreeDecompositionProcessor(const htd::LibraryInstance * const manager);

            /**
             *  Destructor of a graph processor.
             */
            virtual ~GrFormatGraphToTreeDecompositionProcessor();
...
#endif /* HTD_MAIN_GRFORMATGRAPHTOTREEDECOMPOSITIONPROCESSOR_HPP */
