...
#ifndef HTD_MAIN_LPFORMATGRAPHTOTREEDECOMPOSITIONPROCESSOR_HPP
#define HTD_MAIN_LPFORMATGRAPHTOTREEDECOMPOSITIONPROCESSOR_HPP
...
namespace htd_main
{
     ...
     */
    class LpFormatGraphToTreeDecompositionProcessor : public htd_main::IGraphToTreeDecompositionProcessor
    {
        public:
            /**
             *  Constructor for a new graph processor.
             */
            LpFormatGraphToTreeDecompositionProcessor(const htd::LibraryInstance * const manager);

            /**
             *  Destructor of a graph processor.
             */
            virtual ~LpFormatGraphToTreeDecompositionProcessor();
...
#endif /* HTD_MAIN_LPFORMATGRAPHTOTREEDECOMPOSITIONPROCESSOR_HPP */
