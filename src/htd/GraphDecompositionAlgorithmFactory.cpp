...
htd::GraphDecompositionAlgorithmFactory::GraphDecompositionAlgorithmFactory(const htd::LibraryInstance * const manager) : htd::AlgorithmFactory<htd::IGraphDecompositionAlgorithm>(new htd::BucketEliminationGraphDecompositionAlgorithm(manager))
{
...
htd::IGraphDecompositionAlgorithm * htd::GraphDecompositionAlgorithmFactory::createInstance(void) const
{
