...
htd::HypertreeDecompositionAlgorithmFactory::HypertreeDecompositionAlgorithmFactory(const htd::LibraryInstance * const manager) : htd::AlgorithmFactory<htd::IHypertreeDecompositionAlgorithm>(new htd::HypertreeDecompositionAlgorithm(manager))
{
...
htd::IHypertreeDecompositionAlgorithm * htd::HypertreeDecompositionAlgorithmFactory::createInstance(void) const
{
