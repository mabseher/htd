...
struct htd::WidthMinimizingTreeDecompositionAlgorithm::Implementation
{
    ...
    Implementation(const htd::LibraryInstance * const manager)
        : managementInstance_(manager), algorithm_(new htd::BucketEliminationTreeDecompositionAlgorithm(manager)), iterationCount_(10)
    {
    ...
    Implementation(const htd::LibraryInstance * const manager, const std::vector<htd::IDecompositionManipulationOperation *> & manipulationOperations)
        : managementInstance_(manager), algorithm_(new htd::BucketEliminationTreeDecompositionAlgorithm(manager, manipulationOperations)), iterationCount_(10)
    {
