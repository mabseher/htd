/*
 * File:   MaximumCardinalitySearchOrderingAlgorithmTest.cpp
 *
...
class MaximumCardinalitySearchOrderingAlgorithmTest : public ::testing::Test
{
    public:
        MaximumCardinalitySearchOrderingAlgorithmTest(void)
        {

        }

        virtual ~MaximumCardinalitySearchOrderingAlgorithmTest()
        {
...
bool isValidOrdering(htd::MultiHypergraph & graph, const std::vector<htd::vertex_t> & ordering)
{
    ...
    std::unordered_map<htd::vertex_t, std::size_t> weights;
    ...
    for (auto it = ordering.rbegin(); ret && it != ordering.rend(); ++it)
    {
        htd::vertex_t vertex = *it;

        std::vector<htd::vertex_t> optimalChoices;
        ...
        for (htd::vertex_t vertex : graph.vertices())
        {
            ...
            if (tmp >= maxCardinality)
            {
                if (tmp > maxCardinality)
                {
                    ...
                    optimalChoices.clear();
                }

                optimalChoices.push_back(vertex);
            }
        }
...
TEST(MaximumCardinalitySearchOrderingAlgorithmTest, CheckEmptyGraph)
{
...
TEST(MaximumCardinalitySearchOrderingAlgorithmTest, CheckSize1Graph)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(MaximumCardinalitySearchOrderingAlgorithmTest, CheckSize2Graph)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(MaximumCardinalitySearchOrderingAlgorithmTest, CheckSimpleGraph1)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(MaximumCardinalitySearchOrderingAlgorithmTest, CheckSimpleGraph2)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(MaximumCardinalitySearchOrderingAlgorithmTest, CheckSimpleGraph3)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(MaximumCardinalitySearchOrderingAlgorithmTest, CheckSimpleGraph4)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(MaximumCardinalitySearchOrderingAlgorithmTest, CheckSimpleGraph5)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(MaximumCardinalitySearchOrderingAlgorithmTest, CheckSize50Graph)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
