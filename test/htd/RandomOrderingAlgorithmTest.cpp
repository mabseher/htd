/*
 * File:   RandomOrderingAlgorithmTest.cpp
 *
...
class RandomOrderingAlgorithmTest : public ::testing::Test
{
    public:
        RandomOrderingAlgorithmTest(void)
        {

        }

        virtual ~RandomOrderingAlgorithmTest()
        {
...
TEST(RandomOrderingAlgorithmTest, CheckCloneMethod)
{
    ...
    htd::RandomOrderingAlgorithm algorithm(libraryInstance1);

    htd::RandomOrderingAlgorithm * clonedAlgorithm = algorithm.clone();
...
TEST(RandomOrderingAlgorithmTest, CheckEmptyGraph)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);

    htd::MultiHypergraph graph(libraryInstance);

    htd::RandomOrderingAlgorithm algorithm(libraryInstance);
...
TEST(RandomOrderingAlgorithmTest, CheckSize1Graph)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(RandomOrderingAlgorithmTest, CheckSize2Graph)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(RandomOrderingAlgorithmTest, CheckSimpleGraph1)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(RandomOrderingAlgorithmTest, CheckSimpleGraph2)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(RandomOrderingAlgorithmTest, CheckSimpleGraph3)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(RandomOrderingAlgorithmTest, CheckSimpleGraph4)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(RandomOrderingAlgorithmTest, CheckSimpleGraph5)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(RandomOrderingAlgorithmTest, CheckSize50Graph1)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
...
TEST(RandomOrderingAlgorithmTest, CheckSize50Graph2)
{
    htd::LibraryInstance * libraryInstance = htd::createManagementInstance(htd::Id::FIRST);
